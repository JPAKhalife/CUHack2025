...
function buildComputedView(client, operation) {
  const f = operation.variables ? async (variables = {}) => {
    ...
    return await (0, import_computedViews.computedViewRunner)(client.connection, operation.gqlFieldName, resultVariables, operation.namespace);
  } : async () => {
  ...
  return Object.assign(f, operation, {
    plan: function(variables) {
      return (0, import_computedViews.computedViewOperation)(operation.operationName, variables, operation.namespace);
    }
  });
}
