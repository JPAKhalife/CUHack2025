...
import { GadgetRecord, User } from "@gadget-client/shapesplosion";
...
export interface UpdateUserActionContext extends AmbientContext {
  ...
  */
  params: {
user?: { firstName?: string;lastName?: string;email?: string;emailVerified?: boolean;googleImageUrl?: string;googleProfileId?: string;roles?: string[];lastSignedIn?: Date;password?: string;emailVerificationToken?: string;emailVerificationTokenExpiration?: Date;resetPasswordToken?: string;resetPasswordTokenExpiration?: Date; };    
id?: string;
};
  /**
  * @private The context of this action.
