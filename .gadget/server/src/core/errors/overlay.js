...
const FixIconUrl = `data:image/svg+xml;base64,${btoa(`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const overlayTemplate = (overlayStyle)=>{
    return /* html */ `
<style>
  ${Style(overlayStyle)}
</style>
