...
import { Client } from "@gadget-client/shapesplosion";
...
declare module "fastify" {
	interface FastifyRequest {
		...
		/** All shapesplosion configuration values */
		config: AppConfiguration;
		/** A map of connection name to instantiated connection objects for shapesplosion */
